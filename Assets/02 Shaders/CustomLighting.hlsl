...
{
    // Light base color
    float3 radiance = _light.color * _light.shadowAttenuation;
...
void CustomLighting_float(float3 PositionWS, float3 NormalWS, float3 ViewDirWS, float3 Albedo, float Smoothness, out float3 Color)
{
